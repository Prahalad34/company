...
import 'package:yakcompany/Screens/AddVehiclePhotos.dart';
import 'package:yakcompany/Widgets/button_widget.dart';

class AddVehicleDocuments extends StatefulWidget {
  const AddVehicleDocuments({super.key});

  @override
  State<AddVehicleDocuments> createState() => _AddVehicleDocumentsState();
}

class _AddVehicleDocumentsState extends State<AddVehicleDocuments> {
            ...
            child: Padding(
                ...
                child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: [
                      Text(
                        'Upload all images of your vehicle Documents',
                        style: TextStyle(
                            fontSize: 15.0,
                      ...
                      const SizedBox(
                        height: 7,
                          ...
                          RichText(
                            textAlign: TextAlign.center,
                            text: TextSpan(
                              text: 'Vehicle registration front',
                              style: smallText,
                              children: <TextSpan>[
                                TextSpan(
                                    text: '*',
                          ...
                          RichText(
                            textAlign: TextAlign.center,
                            text: TextSpan(
                              text: 'Vehicle registration back',
                              style: smallText,
                              children: <TextSpan>[
                                TextSpan(
                                    text: '*',
