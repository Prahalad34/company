...
import 'package:yakcompany/Screens/CompleteAdd.dart';
import 'package:yakcompany/Widgets/button_widget.dart';

class ConfirmVehicleDetails extends StatefulWidget {
  const ConfirmVehicleDetails({super.key});

  @override
  State<ConfirmVehicleDetails> createState() => _ConfirmVehicleDetailsState();
}

class _ConfirmVehicleDetailsState extends State<ConfirmVehicleDetails> {
