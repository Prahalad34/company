...
class CompleteAdd extends StatefulWidget {
  const CompleteAdd({super.key});

  @override
  State<CompleteAdd> createState() => _CompleteAddState();
}

class _CompleteAddState extends State<CompleteAdd> {
  ...
  TextStyle basicText = TextStyle(
      fontSize: 19.0, fontWeight: FontWeight.bold, color: AppColors.blackColor);
    ...
    return  Scaffold(
      body: Padding(padding: const EdgeInsets.only(left: 25,right: 25,top: 15,bottom: 15),
        child: Column(children: [
          ...
          Text(
            'Your request to add a new vehicle to your fleet has been successfully submitted.',
